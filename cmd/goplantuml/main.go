...
func main() {
	...
	buildTags := flag.String("build-tags", "", "comma separated list of tags for build constraints")
	...
	result, err := goplantuml.NewClassDiagram(dirs, ignoredDirectories, *recursive, *buildTags)
